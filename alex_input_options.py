...
''''
	High Circuits Utilization Reports Valid Options
'''

VALID_OPTIONS = {}
VALID_OPTIONS['-plan-file'] = {}
VALID_OPTIONS['-plan-file']['type'] = 'srcfile'
VALID_OPTIONS['-plan-file']['description'] = 'Input plan-file'
VALID_OPTIONS['-plan-file']['REQUIRED'] = 1
VALID_OPTIONS['-out-file'] = {}
VALID_OPTIONS['-out-file']['type'] = 'wrtfile'
VALID_OPTIONS['-out-file']['description'] = 'Output plan-file'
VALID_OPTIONS['-out-file']['REQUIRED'] = 1
VALID_OPTIONS['-col'] = {}
VALID_OPTIONS['-col']['type'] = 'string'
VALID_OPTIONS['-col']['description'] = 'type of traffic to use'
VALID_OPTIONS['-col']['required'] = 0
VALID_OPTIONS['-col']['default'] = 'Simulated'
VALID_OPTIONS['-col']['allowed'] = ['Measured', 'Simulated', 'Worst-Case']
VALID_OPTIONS['-col']['REQUIRED'] = 0
VALID_OPTIONS['-run-sim'] = {}
VALID_OPTIONS['-run-sim']['type'] = 'boolean'
VALID_OPTIONS['-run-sim']['description'] = 'Run SimAnalysis'
VALID_OPTIONS['-run-sim']['REQUIRED'] = 0
VALID_OPTIONS['-run-sim']['allowed'] = ['true', 'false']
VALID_OPTIONS['-run-sim']['default'] = 'false'
VALID_OPTIONS['-help'] = {}
VALID_OPTIONS['-help']['type'] = ''
VALID_OPTIONS['-help']['description'] = 'Show this help screen'
VALID_OPTIONS['-help']['REQUIRED'] = 0
VALID_OPTIONS['-help']['default'] = 'false'
VALID_OPTIONS['-circuits'] = {}
VALID_OPTIONS['-circuits']['type'] = 'srcfile'
VALID_OPTIONS['-circuits']['description'] = 'Selected in table'
VALID_OPTIONS['-circuits']['REQUIRED'] = 0

VALID_OPTIONS['-Option1'] = {}
VALID_OPTIONS['-Option1']['type'] = 'srcfile'
VALID_OPTIONS['-Option1']['description'] = 'Selected in table'
VALID_OPTIONS['-Option1']['REQUIRED'] = 0

VALID_OPTIONS['-Option2'] = {}
VALID_OPTIONS['-Option2']['type'] = 'string'
VALID_OPTIONS['-Option2']['description'] = 'type of traffic to use'
VALID_OPTIONS['-Option2']['required'] = 0
VALID_OPTIONS['-Option2']['default'] = 'Alex range 01'
VALID_OPTIONS['-Option2']['allowed'] = ['Alex range 01', 'Alex range 02', 'Alex range 03']
VALID_OPTIONS['-Option2']['REQUIRED'] = 0

VALID_OPTIONS['-Option3'] = {}
VALID_OPTIONS['-Option3']['type'] = 'boolean'
VALID_OPTIONS['-Option3']['description'] = 'Option 3 check box'
VALID_OPTIONS['-Option3']['REQUIRED'] = 0
VALID_OPTIONS['-Option3']['allowed'] = ['true', 'false']
VALID_OPTIONS['-Option3']['default'] = 'false'


# Options required for ADDONS
VALID_OPTIONS['-version'] = {}
VALID_OPTIONS['-version']['type'] = ''
VALID_OPTIONS['-version']['description'] = 'Shows current version'
VALID_OPTIONS['-version']['REQUIRED'] = 0
VALID_OPTIONS['-version']['hidden'] = 1
VALID_OPTIONS['-mate-version'] = {}
VALID_OPTIONS['-mate-version']['type'] = 'string'
VALID_OPTIONS['-mate-version']['description'] = 'Current WAE Version'
VALID_OPTIONS['-mate-version']['REQUIRED'] = 0
VALID_OPTIONS['-mate-version']['hidden'] = 1
VALID_OPTIONS['-pdf-report-file'] = {}
VALID_OPTIONS['-pdf-report-file']['type'] = 'string'
VALID_OPTIONS['-pdf-report-file']['description'] = 'deprecated'
VALID_OPTIONS['-pdf-report-file']['REQUIRED'] = 0
VALID_OPTIONS['-pdf-report-file']['hidden'] = 1
VALID_OPTIONS['-report-dir'] = {}
VALID_OPTIONS['-report-dir']['type'] = 'string'
VALID_OPTIONS['-report-dir']['description'] = ''
VALID_OPTIONS['-report-dir']['REQUIRED'] = 0
VALID_OPTIONS['-report-dir']['hidden'] = 1
VALID_OPTIONS['-report-file'] = {}
VALID_OPTIONS['-report-file']['type'] = 'string'
VALID_OPTIONS['-report-file']['description'] = 'deprecated'
VALID_OPTIONS['-report-file']['REQUIRED'] = 0
VALID_OPTIONS['-report-file']['hidden'] = 1
VALID_OPTIONS['-return-config-file'] = {}
VALID_OPTIONS['-return-config-file']['type'] = 'string'
VALID_OPTIONS['-return-config-file']['description'] = ''
VALID_OPTIONS['-return-config-file']['REQUIRED'] = 0
VALID_OPTIONS['-return-config-file']['hidden'] = 1
